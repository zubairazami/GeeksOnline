                ...
                <div class="pure-u-2-3" id="bodysection">   
                    ...
                    <div id="homemain">
                        ...
                        <?php 
                            ...
                            $query1 = "SELECT `postid`, `post`.`userid`, `username`, `postheader`, `tag1`, `tag2`, `tag3`, `post`.`rating`, `time` FROM `post` JOIN `userprofile` ON `post`.`userid` = `userprofile`.`userid` ORDER BY `post`.`time` DESC";
                            if($query_run1=mysql_query($query1))
                            {
