                ...
                <div class="pure-u-2-3" id="bodysection">   
                    ...
                    <div id="homemain">
                        ...
                        <?php 
                            ...
                            $query1 = "SELECT `postid`, `post`.`userid`, `username`, `postheader`, `tag1`, `tag2`, `tag3`, `post`.`rating`, `time` FROM `post` JOIN `userprofile` ON `post`.`userid` = `userprofile`.`userid` WHERE `username` = '".$user."' ORDER BY `post`.`time` DESC";
                            ...
                            if($query_run1=mysql_query($query1))
                            {
                                ...
                                for($i=0;$i<$size;$i++)
                                {
                                    echo '
                                        <div id="questiondiv">
                                            <table id="questiontable" cellspacing="3px" cellpadding="0px">
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id = "smalltd2">
                                                        <form method = "POST" action ="/ip/questionedit.php"> <button name="postedit" id="smallbutton" value="'.$postid[$i].'">Edit</button></form>
                                                    </td>
