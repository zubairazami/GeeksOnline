    ...
    <div id="wholesection" >
        ...
        <div id="top" >  
            ...
            <div id="loginregister">
                    ...
                    <table id="logintable" cellspacing ="5px" cellpadding ="5px">
                ...
                <div class="pure-u-2-3" id="bodysection">   
                    ...
                    <div id="homemain">
                        ...
                        <?php 
                            ...
                            $query1 = "SELECT post.postid, post.userid, login.username, post.postheader, post.tag1, post.tag2, post.tag3, post.rating, post.time
FROM COMMENT JOIN post ON comment.postid = post.postid
JOIN login ON post.userid = login.userid
WHERE comment.userid =".$uid."
